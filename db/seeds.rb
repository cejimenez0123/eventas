...
e3= Event.create(name: "Rolling Loud", dis: "Rolling Loud is a recurring music festival held in the United States of America.", user_id: a.id)
e4= Event.create(name: "Electric Zoo", dis: "Electric Zoo is an annual electronic music festival held over Labor Day weekend in New York City on Randall's Island." , user_id: b.id)
